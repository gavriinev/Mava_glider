...
# Import GliderMA
try:
    from .environments.glider_ma import GliderMA
    _HAS_GLIDER = True
except ImportError:
    _HAS_GLIDER = False
    GliderMA = None
...
def make(env_id: str, **env_kwargs):
    ...
    #     env = OvercookedV2(**env_kwargs)  # OvercookedV2 not available in this version
    ...
    # 10. GliderMA
    elif env_id == "glider_ma":
        if not _HAS_GLIDER:
            raise ImportError("GliderMA requires stoix.utils.wind module. Please install stoix.")
        env = GliderMA(**env_kwargs)
...
registered_envs = [
    ...
    "hanabi",
    "overcooked",
    # "overcooked_v2",  # OvercookedV2 not available in this version
    "coin_game",
    "jaxnav",
    "glider_ma",
]
